...
class RobotnikMoveBaseFlexActionGoal {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('goal')) {
        ...
        this.goal = new RobotnikMoveBaseFlexGoal();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = RobotnikMoveBaseFlexGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new RobotnikMoveBaseFlexActionGoal(null);
    // Deserialize message field [header]
    data.header = std_msgs.msg.Header.deserialize(buffer, bufferOffset);
    // Deserialize message field [goal_id]
    data.goal_id = actionlib_msgs.msg.GoalID.deserialize(buffer, bufferOffset);
    // Deserialize message field [goal]
    data.goal = RobotnikMoveBaseFlexGoal.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += RobotnikMoveBaseFlexGoal.getMessageSize(object.goal);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new RobotnikMoveBaseFlexActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = RobotnikMoveBaseFlexGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new RobotnikMoveBaseFlexGoal()
    }
...
module.exports = RobotnikMoveBaseFlexActionGoal;

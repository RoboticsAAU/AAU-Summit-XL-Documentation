...
class WaitActionFeedback {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = WaitFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new WaitActionFeedback(null);
    ...
    data.feedback = WaitFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new WaitActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = WaitFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new WaitFeedback()
    }
...
module.exports = WaitActionFeedback;

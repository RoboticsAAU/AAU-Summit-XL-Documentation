...
class WaitActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = WaitGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new WaitActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = WaitGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new WaitGoal()
    }

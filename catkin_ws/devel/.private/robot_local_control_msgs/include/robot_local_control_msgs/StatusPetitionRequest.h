// Generated by gencpp from file robot_local_control_msgs/StatusPetitionRequest.msg
// DO NOT EDIT!


#ifndef ROBOT_LOCAL_CONTROL_MSGS_MESSAGE_STATUSPETITIONREQUEST_H
#define ROBOT_LOCAL_CONTROL_MSGS_MESSAGE_STATUSPETITIONREQUEST_H
...
struct StatusPetitionRequest_
{
  typedef StatusPetitionRequest_<ContainerAllocator> Type;

  StatusPetitionRequest_()
    : procedure()  {
    }
  StatusPetitionRequest_(const ContainerAllocator& _alloc)
    : procedure(_alloc)  {
  (void)_alloc;
    }
   ...
   typedef  ::robot_local_control_msgs::Status_<ContainerAllocator>  _procedure_type;
  ...
  typedef boost::shared_ptr< ::robot_local_control_msgs::StatusPetitionRequest_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::robot_local_control_msgs::StatusPetitionRequest_<ContainerAllocator> const> ConstPtr;

}; // struct StatusPetitionRequest_

typedef ::robot_local_control_msgs::StatusPetitionRequest_<std::allocator<void> > StatusPetitionRequest;

typedef boost::shared_ptr< ::robot_local_control_msgs::StatusPetitionRequest > StatusPetitionRequestPtr;
typedef boost::shared_ptr< ::robot_local_control_msgs::StatusPetitionRequest const> StatusPetitionRequestConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::robot_local_control_msgs::StatusPetitionRequest_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::robot_local_control_msgs::StatusPetitionRequest_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::robot_local_control_msgs::StatusPetitionRequest_<ContainerAllocator1> & lhs, const ::robot_local_control_msgs::StatusPetitionRequest_<ContainerAllocator2> & rhs)
{
...
template <class ContainerAllocator>
struct IsFixedSize< ::robot_local_control_msgs::StatusPetitionRequest_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::robot_local_control_msgs::StatusPetitionRequest_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::robot_local_control_msgs::StatusPetitionRequest_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::robot_local_control_msgs::StatusPetitionRequest_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::robot_local_control_msgs::StatusPetitionRequest_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::robot_local_control_msgs::StatusPetitionRequest_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::robot_local_control_msgs::StatusPetitionRequest_<ContainerAllocator> >
{
  ...
  static const char* value(const ::robot_local_control_msgs::StatusPetitionRequest_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x5c860c7645c0ca22ULL;
  static const uint64_t static_value2 = 0x128261887994fb99ULL;
};

template<class ContainerAllocator>
struct DataType< ::robot_local_control_msgs::StatusPetitionRequest_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::robot_local_control_msgs::StatusPetitionRequest_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::robot_local_control_msgs::StatusPetitionRequest_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::robot_local_control_msgs::StatusPetitionRequest_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::robot_local_control_msgs::StatusPetitionRequest_<ContainerAllocator>& v)
  {
    s << indent << "procedure: ";
    s << std::endl;
    Printer< ::robot_local_control_msgs::Status_<ContainerAllocator> >::stream(s, indent + "  ", v.procedure);
  }
};
...
#endif // ROBOT_LOCAL_CONTROL_MSGS_MESSAGE_STATUSPETITIONREQUEST_H

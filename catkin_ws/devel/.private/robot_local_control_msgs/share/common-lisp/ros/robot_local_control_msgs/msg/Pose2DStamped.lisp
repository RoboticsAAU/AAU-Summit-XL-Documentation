...
(cl:defmethod cl:initialize-instance :after ((m <Pose2DStamped>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Pose2DStamped)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robot_local_control_msgs-msg:<Pose2DStamped> is deprecated: use robot_local_control_msgs-msg:Pose2DStamped instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <Pose2DStamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_local_control_msgs-msg:header-val is deprecated.  Use robot_local_control_msgs-msg:header instead.")
  (header m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Pose2DStamped>)))
  ...
  "robot_local_control_msgs/Pose2DStamped")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Pose2DStamped)))
  "Returns string type for a message object of type 'Pose2DStamped"
  "robot_local_control_msgs/Pose2DStamped")

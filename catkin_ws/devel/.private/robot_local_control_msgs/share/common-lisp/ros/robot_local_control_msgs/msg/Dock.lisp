...
(cl:defmethod cl:initialize-instance :after ((m <Dock>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Dock)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robot_local_control_msgs-msg:<Dock> is deprecated: use robot_local_control_msgs-msg:Dock instead.")))

(cl:ensure-generic-function 'dock_frame-val :lambda-list '(m))
(cl:defmethod dock_frame-val ((m <Dock>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_local_control_msgs-msg:dock_frame-val is deprecated.  Use robot_local_control_msgs-msg:dock_frame instead.")
  (dock_frame m))

(cl:ensure-generic-function 'robot_dock_frame-val :lambda-list '(m))
(cl:defmethod robot_dock_frame-val ((m <Dock>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_local_control_msgs-msg:robot_dock_frame-val is deprecated.  Use robot_local_control_msgs-msg:robot_dock_frame instead.")
  (robot_dock_frame m))

(cl:ensure-generic-function 'dock_offset-val :lambda-list '(m))
(cl:defmethod dock_offset-val ((m <Dock>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_local_control_msgs-msg:dock_offset-val is deprecated.  Use robot_local_control_msgs-msg:dock_offset instead.")
  (dock_offset m))

(cl:ensure-generic-function 'maximum_velocity-val :lambda-list '(m))
(cl:defmethod maximum_velocity-val ((m <Dock>))

...
let PrePlace = require('../msg/PrePlace.js');
...
class PrePlacePetitionRequest {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('procedure')) {
        ...
        this.procedure = new PrePlace();
      }
    }
  }

  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type PrePlacePetitionRequest
    // Serialize message field [procedure]
    bufferOffset = PrePlace.serialize(obj.procedure, buffer, bufferOffset);
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type PrePlacePetitionRequest
    let len;
    let data = new PrePlacePetitionRequest(null);
    // Deserialize message field [procedure]
    data.procedure = PrePlace.deserialize(buffer, bufferOffset);
    return data;
  }

  static getMessageSize(object) {
    let length = 0;
    length += PrePlace.getMessageSize(object.procedure);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new PrePlacePetitionRequest(null);
    if (msg.procedure !== undefined) {
      resolved.procedure = PrePlace.Resolve(msg.procedure)
    }
    else {
      resolved.procedure = new PrePlace()
    }
...
class PrePlacePetitionResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.state = null;
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type PrePlacePetitionResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type PrePlacePetitionResponse
    let len;
    let data = new PrePlacePetitionResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new PrePlacePetitionResponse(null);
...
module.exports = {
  Request: PrePlacePetitionRequest,
  Response: PrePlacePetitionResponse,
  md5sum() { return '9266aaabfab797492e844d2f9a561e03'; },
  datatype() { return 'robot_local_control_msgs/PrePlacePetition'; }
};

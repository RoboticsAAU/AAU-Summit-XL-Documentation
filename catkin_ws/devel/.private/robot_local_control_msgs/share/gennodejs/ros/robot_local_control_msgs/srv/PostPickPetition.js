...
let PostPick = require('../msg/PostPick.js');
...
class PostPickPetitionRequest {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('procedure')) {
        ...
        this.procedure = new PostPick();
      }
    }
  }

  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type PostPickPetitionRequest
    // Serialize message field [procedure]
    bufferOffset = PostPick.serialize(obj.procedure, buffer, bufferOffset);
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type PostPickPetitionRequest
    let len;
    let data = new PostPickPetitionRequest(null);
    // Deserialize message field [procedure]
    data.procedure = PostPick.deserialize(buffer, bufferOffset);
    return data;
  }

  static getMessageSize(object) {
    let length = 0;
    length += PostPick.getMessageSize(object.procedure);
    return length;
  }

  static datatype() {
    // Returns string type for a service object
    return 'robot_local_control_msgs/PostPickPetitionRequest';
  }
  ...
  static messageDefinition() {
    ...
    ================================================================================
    MSG: robot_local_control_msgs/PostPick
  ...
  static Resolve(msg) {
    ...
    const resolved = new PostPickPetitionRequest(null);
    if (msg.procedure !== undefined) {
      resolved.procedure = PostPick.Resolve(msg.procedure)
    }
    else {
      resolved.procedure = new PostPick()
    }
...
class PostPickPetitionResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.state = null;
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type PostPickPetitionResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type PostPickPetitionResponse
    let len;
    let data = new PostPickPetitionResponse(null);
  ...
  static datatype() {
    // Returns string type for a service object
    return 'robot_local_control_msgs/PostPickPetitionResponse';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new PostPickPetitionResponse(null);
...
module.exports = {
  Request: PostPickPetitionRequest,
  Response: PostPickPetitionResponse,
  md5sum() { return '128b8c48c0209b2b9cf5cb28ef7c6494'; },
  datatype() { return 'robot_local_control_msgs/PostPickPetition'; }
};

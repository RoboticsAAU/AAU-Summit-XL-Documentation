...
let LeaveMagneticGuide = require('../msg/LeaveMagneticGuide.js');
...
class LeaveMagneticGuidePetitionRequest {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('procedure')) {
        ...
        this.procedure = new LeaveMagneticGuide();
      }
    }
  }

  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type LeaveMagneticGuidePetitionRequest
    // Serialize message field [procedure]
    bufferOffset = LeaveMagneticGuide.serialize(obj.procedure, buffer, bufferOffset);
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type LeaveMagneticGuidePetitionRequest
    let len;
    let data = new LeaveMagneticGuidePetitionRequest(null);
    // Deserialize message field [procedure]
    data.procedure = LeaveMagneticGuide.deserialize(buffer, bufferOffset);
    return data;
  }

  static getMessageSize(object) {
    let length = 0;
    length += LeaveMagneticGuide.getMessageSize(object.procedure);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new LeaveMagneticGuidePetitionRequest(null);
    if (msg.procedure !== undefined) {
      resolved.procedure = LeaveMagneticGuide.Resolve(msg.procedure)
    }
    else {
      resolved.procedure = new LeaveMagneticGuide()
    }
...
class LeaveMagneticGuidePetitionResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.state = null;
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type LeaveMagneticGuidePetitionResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type LeaveMagneticGuidePetitionResponse
    let len;
    let data = new LeaveMagneticGuidePetitionResponse(null);
  ...
  static datatype() {
    // Returns string type for a service object
    return 'robot_local_control_msgs/LeaveMagneticGuidePetitionResponse';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new LeaveMagneticGuidePetitionResponse(null);
...
module.exports = {
  Request: LeaveMagneticGuidePetitionRequest,
  Response: LeaveMagneticGuidePetitionResponse,
  md5sum() { return '128b8c48c0209b2b9cf5cb28ef7c6494'; },
  datatype() { return 'robot_local_control_msgs/LeaveMagneticGuidePetition'; }
};

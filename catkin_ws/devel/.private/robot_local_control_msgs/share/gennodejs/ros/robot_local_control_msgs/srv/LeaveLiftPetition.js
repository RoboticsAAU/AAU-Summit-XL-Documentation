...
let LeaveLift = require('../msg/LeaveLift.js');
...
class LeaveLiftPetitionRequest {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('procedure')) {
        ...
        this.procedure = new LeaveLift();
      }
    }
  }

  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type LeaveLiftPetitionRequest
    // Serialize message field [procedure]
    bufferOffset = LeaveLift.serialize(obj.procedure, buffer, bufferOffset);
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type LeaveLiftPetitionRequest
    let len;
    let data = new LeaveLiftPetitionRequest(null);
    // Deserialize message field [procedure]
    data.procedure = LeaveLift.deserialize(buffer, bufferOffset);
    return data;
  }

  static getMessageSize(object) {
    let length = 0;
    length += LeaveLift.getMessageSize(object.procedure);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new LeaveLiftPetitionRequest(null);
    if (msg.procedure !== undefined) {
      resolved.procedure = LeaveLift.Resolve(msg.procedure)
    }
    else {
      resolved.procedure = new LeaveLift()
    }
...
class LeaveLiftPetitionResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.state = null;
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type LeaveLiftPetitionResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type LeaveLiftPetitionResponse
    let len;
    let data = new LeaveLiftPetitionResponse(null);
  ...
  static datatype() {
    // Returns string type for a service object
    return 'robot_local_control_msgs/LeaveLiftPetitionResponse';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new LeaveLiftPetitionResponse(null);
...
module.exports = {
  Request: LeaveLiftPetitionRequest,
  Response: LeaveLiftPetitionResponse,
  md5sum() { return 'ecdb7d18cedc65353c1996690a8c9cd1'; },
  datatype() { return 'robot_local_control_msgs/LeaveLiftPetition'; }
};

...
let PrePick = require('../msg/PrePick.js');
...
class PrePickPetitionRequest {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('procedure')) {
        ...
        this.procedure = new PrePick();
      }
    }
  }

  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type PrePickPetitionRequest
    // Serialize message field [procedure]
    bufferOffset = PrePick.serialize(obj.procedure, buffer, bufferOffset);
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type PrePickPetitionRequest
    let len;
    let data = new PrePickPetitionRequest(null);
    // Deserialize message field [procedure]
    data.procedure = PrePick.deserialize(buffer, bufferOffset);
    return data;
  }

  static getMessageSize(object) {
    let length = 0;
    length += PrePick.getMessageSize(object.procedure);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new PrePickPetitionRequest(null);
    if (msg.procedure !== undefined) {
      resolved.procedure = PrePick.Resolve(msg.procedure)
    }
    else {
      resolved.procedure = new PrePick()
    }
...
class PrePickPetitionResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type PrePickPetitionResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type PrePickPetitionResponse
    let len;
    let data = new PrePickPetitionResponse(null);
  ...
  static datatype() {
    // Returns string type for a service object
    return 'robot_local_control_msgs/PrePickPetitionResponse';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new PrePickPetitionResponse(null);
...
module.exports = {
  Request: PrePickPetitionRequest,
  Response: PrePickPetitionResponse,
  md5sum() { return '128b8c48c0209b2b9cf5cb28ef7c6494'; },
  datatype() { return 'robot_local_control_msgs/PrePickPetition'; }
};

...
let Uncharge = require('../msg/Uncharge.js');
...
class UnchargePetitionRequest {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('procedure')) {
        ...
        this.procedure = new Uncharge();
      }
    }
  }

  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type UnchargePetitionRequest
    // Serialize message field [procedure]
    bufferOffset = Uncharge.serialize(obj.procedure, buffer, bufferOffset);
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type UnchargePetitionRequest
    let len;
    let data = new UnchargePetitionRequest(null);
    // Deserialize message field [procedure]
    data.procedure = Uncharge.deserialize(buffer, bufferOffset);
    return data;
  }

  static getMessageSize(object) {
    let length = 0;
    length += Uncharge.getMessageSize(object.procedure);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new UnchargePetitionRequest(null);
    if (msg.procedure !== undefined) {
      resolved.procedure = Uncharge.Resolve(msg.procedure)
    }
    else {
      resolved.procedure = new Uncharge()
    }
...
class UnchargePetitionResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.state = null;
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type UnchargePetitionResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type UnchargePetitionResponse
    let len;
    let data = new UnchargePetitionResponse(null);
  ...
  static datatype() {
    // Returns string type for a service object
    return 'robot_local_control_msgs/UnchargePetitionResponse';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new UnchargePetitionResponse(null);
...
module.exports = {
  Request: UnchargePetitionRequest,
  Response: UnchargePetitionResponse,
  md5sum() { return 'd6d7f27a9204b33d4b52fe501814a3cf'; },
  datatype() { return 'robot_local_control_msgs/UnchargePetition'; }
};

...
let MagneticNavigation = require('../msg/MagneticNavigation.js');
...
class MagneticNavigationPetitionRequest {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('procedure')) {
        ...
        this.procedure = new MagneticNavigation();
      }
    }
  }

  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type MagneticNavigationPetitionRequest
    // Serialize message field [procedure]
    bufferOffset = MagneticNavigation.serialize(obj.procedure, buffer, bufferOffset);
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type MagneticNavigationPetitionRequest
    let len;
    let data = new MagneticNavigationPetitionRequest(null);
    // Deserialize message field [procedure]
    data.procedure = MagneticNavigation.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new MagneticNavigationPetitionRequest(null);
    if (msg.procedure !== undefined) {
      resolved.procedure = MagneticNavigation.Resolve(msg.procedure)
    }
    else {
      resolved.procedure = new MagneticNavigation()
    }
...
class MagneticNavigationPetitionResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.state = null;
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type MagneticNavigationPetitionResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type MagneticNavigationPetitionResponse
    let len;
    let data = new MagneticNavigationPetitionResponse(null);
  ...
  static datatype() {
    // Returns string type for a service object
    return 'robot_local_control_msgs/MagneticNavigationPetitionResponse';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new MagneticNavigationPetitionResponse(null);
...
module.exports = {
  Request: MagneticNavigationPetitionRequest,
  Response: MagneticNavigationPetitionResponse,
  md5sum() { return '4c61549b5bc9677b02bc32b423741952'; },
  datatype() { return 'robot_local_control_msgs/MagneticNavigationPetition'; }
};

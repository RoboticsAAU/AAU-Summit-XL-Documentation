...
class BatteryExchangePetitionRequest {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('procedure')) {
        ...
        this.procedure = new std_msgs.msg.Empty();
      }
    }
  }

  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type BatteryExchangePetitionRequest
    // Serialize message field [procedure]
    bufferOffset = std_msgs.msg.Empty.serialize(obj.procedure, buffer, bufferOffset);
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type BatteryExchangePetitionRequest
    let len;
    let data = new BatteryExchangePetitionRequest(null);
    // Deserialize message field [procedure]
    data.procedure = std_msgs.msg.Empty.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new BatteryExchangePetitionRequest(null);
    if (msg.procedure !== undefined) {
      resolved.procedure = std_msgs.msg.Empty.Resolve(msg.procedure)
    }
    else {
      resolved.procedure = new std_msgs.msg.Empty()
    }
...
class BatteryExchangePetitionResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.state = null;
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type BatteryExchangePetitionResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type BatteryExchangePetitionResponse
    let len;
    let data = new BatteryExchangePetitionResponse(null);
  ...
  static datatype() {
    // Returns string type for a service object
    return 'robot_local_control_msgs/BatteryExchangePetitionResponse';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new BatteryExchangePetitionResponse(null);
...
module.exports = {
  Request: BatteryExchangePetitionRequest,
  Response: BatteryExchangePetitionResponse,
  md5sum() { return 'df9f6e13e8a091f070823f91bb1ba8e3'; },
  datatype() { return 'robot_local_control_msgs/BatteryExchangePetition'; }
};

...
let Place = require('../msg/Place.js');
...
class PlacePetitionRequest {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('procedure')) {
        ...
        this.procedure = new Place();
      }
    }
  }

  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type PlacePetitionRequest
    // Serialize message field [procedure]
    bufferOffset = Place.serialize(obj.procedure, buffer, bufferOffset);
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type PlacePetitionRequest
    let len;
    let data = new PlacePetitionRequest(null);
    // Deserialize message field [procedure]
    data.procedure = Place.deserialize(buffer, bufferOffset);
    return data;
  }

  static getMessageSize(object) {
    let length = 0;
    length += Place.getMessageSize(object.procedure);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new PlacePetitionRequest(null);
    if (msg.procedure !== undefined) {
      resolved.procedure = Place.Resolve(msg.procedure)
    }
    else {
      resolved.procedure = new Place()
    }
...
class PlacePetitionResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type PlacePetitionResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type PlacePetitionResponse
    let len;
    let data = new PlacePetitionResponse(null);
  ...
  static datatype() {
    // Returns string type for a service object
    return 'robot_local_control_msgs/PlacePetitionResponse';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new PlacePetitionResponse(null);
...
module.exports = {
  Request: PlacePetitionRequest,
  Response: PlacePetitionResponse,
  md5sum() { return '44c7093f5d45a75a03470d3d82ca14f6'; },
  datatype() { return 'robot_local_control_msgs/PlacePetition'; }
};

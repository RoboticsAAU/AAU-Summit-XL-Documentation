...
let MagneticPlace = require('../msg/MagneticPlace.js');
...
class MagneticPlacePetitionRequest {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('procedure')) {
        ...
        this.procedure = new MagneticPlace();
      }
    }
  }

  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type MagneticPlacePetitionRequest
    // Serialize message field [procedure]
    bufferOffset = MagneticPlace.serialize(obj.procedure, buffer, bufferOffset);
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type MagneticPlacePetitionRequest
    let len;
    let data = new MagneticPlacePetitionRequest(null);
    // Deserialize message field [procedure]
    data.procedure = MagneticPlace.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static datatype() {
    ...
    return 'robot_local_control_msgs/MagneticPlacePetitionRequest';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new MagneticPlacePetitionRequest(null);
    if (msg.procedure !== undefined) {
      resolved.procedure = MagneticPlace.Resolve(msg.procedure)
    }
    else {
      resolved.procedure = new MagneticPlace()
    }
...
class MagneticPlacePetitionResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
      this.state = null;
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type MagneticPlacePetitionResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type MagneticPlacePetitionResponse
    let len;
    let data = new MagneticPlacePetitionResponse(null);
  ...
  static datatype() {
    // Returns string type for a service object
    return 'robot_local_control_msgs/MagneticPlacePetitionResponse';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new MagneticPlacePetitionResponse(null);
...
module.exports = {
  Request: MagneticPlacePetitionRequest,
  Response: MagneticPlacePetitionResponse,
  md5sum() { return '4c61549b5bc9677b02bc32b423741952'; },
  datatype() { return 'robot_local_control_msgs/MagneticPlacePetition'; }
};

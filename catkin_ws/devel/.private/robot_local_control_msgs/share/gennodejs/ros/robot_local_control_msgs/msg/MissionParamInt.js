...
class MissionParamInt {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new MissionParamInt(null);
  ...
  static datatype() {
    ...
    return 'robot_local_control_msgs/MissionParamInt';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new MissionParamInt(null);
...
module.exports = MissionParamInt;

...
let Charge = require('../msg/Charge.js');
...
class ChargePetitionRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type ChargePetitionRequest
    // Serialize message field [procedure]
    bufferOffset = Charge.serialize(obj.procedure, buffer, bufferOffset);
    return bufferOffset;
  }

  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type ChargePetitionRequest
    let len;
    let data = new ChargePetitionRequest(null);
    // Deserialize message field [procedure]
    data.procedure = Charge.deserialize(buffer, bufferOffset);
    return data;
  }

  static getMessageSize(object) {
    let length = 0;
    length += Charge.getMessageSize(object.procedure);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ChargePetitionRequest(null);
    if (msg.procedure !== undefined) {
      resolved.procedure = Charge.Resolve(msg.procedure)
    }
    else {
      resolved.procedure = new Charge()
    }
...
class ChargePetitionResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type ChargePetitionResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type ChargePetitionResponse
    let len;
    let data = new ChargePetitionResponse(null);
  ...
  static datatype() {
    // Returns string type for a service object
    return 'robot_local_control_msgs/ChargePetitionResponse';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ChargePetitionResponse(null);
...
module.exports = {
  Request: ChargePetitionRequest,
  Response: ChargePetitionResponse,
  md5sum() { return 'd6d7f27a9204b33d4b52fe501814a3cf'; },
  datatype() { return 'robot_local_control_msgs/ChargePetition'; }
};

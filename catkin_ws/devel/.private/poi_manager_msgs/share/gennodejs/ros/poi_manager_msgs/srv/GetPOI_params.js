...
class GetPOI_paramsRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type GetPOI_paramsRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type GetPOI_paramsRequest
    let len;
    let data = new GetPOI_paramsRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new GetPOI_paramsRequest(null);
...
class GetPOI_paramsResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type GetPOI_paramsResponse
    // Serialize message field [name]
    bufferOffset = _serializer.string(obj.name, buffer, bufferOffset);
    // Serialize message field [environment]
    bufferOffset = _serializer.string(obj.environment, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type GetPOI_paramsResponse
    let len;
    let data = new GetPOI_paramsResponse(null);
    // Deserialize message field [name]
    data.name = _deserializer.string(buffer, bufferOffset);
    // Deserialize message field [environment]
    data.environment = _deserializer.string(buffer, bufferOffset);
  ...
  static Resolve(msg) {
    ...
    const resolved = new GetPOI_paramsResponse(null);
    if (msg.name !== undefined) {
      resolved.name = msg.name;
    }
    else {
...
module.exports = {
  ...
  md5sum() { return 'a3f80f632bdd70740700383ed303765c'; },
  datatype() { return 'poi_manager_msgs/GetPOI_params'; }
};

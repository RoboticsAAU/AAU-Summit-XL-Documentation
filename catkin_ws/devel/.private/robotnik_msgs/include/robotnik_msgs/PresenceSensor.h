...
struct PresenceSensor_
{
  ...
  _sensor_type_type sensor_type;
   ...
   typedef std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other >  _detected_id_type;
...
// reducing the odds to have name collisions with Windows.h 
  ...
  static const std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other >  PHOTOCELL;
...
struct Printer< ::robotnik_msgs::PresenceSensor_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::robotnik_msgs::PresenceSensor_<ContainerAllocator>& v)
  {
    ...
    Printer<std::basic_string<char, std::char_traits<char>, typename ContainerAllocator::template rebind<char>::other > >::stream(s, indent + "  ", v.detected_id);
    s << indent << "zone: ";

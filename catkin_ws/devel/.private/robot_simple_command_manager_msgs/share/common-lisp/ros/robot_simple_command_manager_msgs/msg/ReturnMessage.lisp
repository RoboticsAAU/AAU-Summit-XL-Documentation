...
(cl:defmethod cl:initialize-instance :after ((m <ReturnMessage>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ReturnMessage)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robot_simple_command_manager_msgs-msg:<ReturnMessage> is deprecated: use robot_simple_command_manager_msgs-msg:ReturnMessage instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ReturnMessage>)))
  ...
  "robot_simple_command_manager_msgs/ReturnMessage")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ReturnMessage)))
  "Returns string type for a message object of type 'ReturnMessage"
  "robot_simple_command_manager_msgs/ReturnMessage")

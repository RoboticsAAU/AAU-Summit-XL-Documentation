...
class RobotSimpleCommandActionGoal {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('goal')) {
        ...
        this.goal = new RobotSimpleCommandGoal();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = RobotSimpleCommandGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new RobotSimpleCommandActionGoal(null);
    // Deserialize message field [header]
    data.header = std_msgs.msg.Header.deserialize(buffer, bufferOffset);
    // Deserialize message field [goal_id]
    data.goal_id = actionlib_msgs.msg.GoalID.deserialize(buffer, bufferOffset);
    // Deserialize message field [goal]
    data.goal = RobotSimpleCommandGoal.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static getMessageSize(object) {
    ...
    length += RobotSimpleCommandGoal.getMessageSize(object.goal);
    return length;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new RobotSimpleCommandActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = RobotSimpleCommandGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new RobotSimpleCommandGoal()
    }
...
module.exports = RobotSimpleCommandActionGoal;

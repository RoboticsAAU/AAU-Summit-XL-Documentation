...
class RobotLeds:
	...
	def __init__(self):
		...
		# Get vel topic
		vel_topic_name = rospy.get_param(self.node_name + "/cmd_vel_topic", "robotnik_base_control/cmd_vel")
		# Verbose for debug
		self.verbose = rospy.get_param(self.node_name + "/verbose", False)
